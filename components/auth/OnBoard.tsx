    ...
    <div className=' flex items-center justify-center bg-[#11becf] bg-cover h-screen'>
      <div>
        ...
        <div className=' flex items-center justify-center'>
          <Link href='/login' className=' bg-white py-4 flex items-center justify-center w-full gap-2.5 max-w-[458px] rounded-[8px] cursor-pointer hover:bg-white/90 transition-colors ease-in duration-300 mx-6 lg:mx-0'> Get Started <RightIcon /> </Link>
