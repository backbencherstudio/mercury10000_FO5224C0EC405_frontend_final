        ...
        <div>
            ...
            <div className='border border-[#D2D2D5] rounded-[8px] p-3 sm:p-6 mt-2.5 flex flex-col lg:flex-row gap-6'>
                <div className='flex-1 p-3 sm:p-6 border border-[#E9E9EA] rounded-[12px]'>
                    <h3 className='text-xl sm:text-2xl text-[#111827] font-medium'>Search Select User Here</h3>
                    <div className='relative my-6'>
                        <SearchIcon className='absolute top-1/2 -translate-y-1/2 left-4' />
                        <input type="text" className='bg-[#e9e9ea] py-2 pl-12 pr-4 rounded-[10px] w-full outline-none focus:ring-1 focus:ring-blue-500' placeholder='Search user here' />
                    </div>
                    <div className='p-3 sm:p-6 border border-[#E9E9EA] rounded-[8px]'>
                        <h3 className='text-xl sm:text-2xl text-[#111827] font-medium'>Basic Details</h3>
                        <div className='mt-6 space-y-6'>
                            <div className='border-b border-[#E9E9EA] p-2'>
                                <h4 className='text-base sm:text-lg text-[#1D1F2C] font-semibold mb-1.5'>User Name</h4>
                                <p className='text-sm sm:text-base text-[#777980]'>Marvin Brandy</p>
                            </div>
                            <div className='border-b border-[#E9E9EA] p-2'>
                                <h4 className='text-base sm:text-lg text-[#1D1F2C] font-semibold mb-1.5'>User ID</h4>
                                <p className='text-sm sm:text-base text-[#777980]'>1237</p>
                            </div>
                            <div className='border-b border-[#E9E9EA] p-2'>
                                <h4 className='text-base sm:text-lg text-[#1D1F2C] font-semibold mb-1.5'>Phone No.</h4>
                                <p className='text-sm sm:text-base text-[#777980]'>+32 2132343</p>
                            </div>
                            <div className='border-b border-[#E9E9EA] p-2'>
                                <h4 className='text-base sm:text-lg text-[#1D1F2C] font-semibold mb-1.5'>City</h4>
                                <p className='text-sm sm:text-base text-[#777980]'>Spain</p>
                            </div>
                            <div className='p-2'>
                                <h4 className='text-base sm:text-lg text-[#1D1F2C] font-semibold mb-1.5'>Work at Company</h4>
                                <p className='text-sm sm:text-base text-[#777980]'>LMS</p>
                            </div>
                        </div>
                ...
                <div className='flex-1 p-3 sm:p-6 border border-[#E9E9EA] rounded-[12px] h-fit'>
                    <h3 className='text-xl sm:text-2xl text-[#111827] font-medium'>Write a Note Summery To Admin</h3>
                    ...
                    <Dialog open={open} onOpenChange={setOpen}>
                        <DialogContent className="p-6 sm:p-16">
                            ...
                            <h2 className='text-center text-xl sm:text-2xl font-medium mt-8'>Summery Sent Successfully To Admin</h2>
                        </DialogContent>
                    </Dialog>
                </div>
            </div>
